function specialHoursController($scope, angularHelper, localizationService) {
    ...
    $scope.model.config.excludeTimes = Object.toBoolean($scope.model.config.excludeTimes)
    ...
    $scope.dateInputChanged = function (index) {
        ...
        if (vm.pickerValue === "" && vm.hasPickerValue) {
            ...
            var momentDate = moment(vm.pickerValue, $scope.model.config.dateFormat, true);
    ...
    function updateModelDateValue(index, momentDate) {
        ...
        if (vm.hasPickerValue) {
            getDateValue(index).date = momentDate.format($scope.model.config.dateFormat);
        }
        else {
            getDateValue(index).date = null;
        }
    ...
    function setDatePickerVal(index) {
        ...
        if (date) {
            ...
            let dateVal = date ? moment(date, $scope.model.config.dateFormat) : moment();
...
angular.module('umbraco')
    .controller('OpenOrClosed.PropertyEditors.SpecialHours.controller', specialHoursController);
