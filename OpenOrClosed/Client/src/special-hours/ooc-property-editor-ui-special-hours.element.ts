...
export class OocPropertyEditorUiSpecialHoursElement extends BusinessHoursBaseElement<SpecialDay, SpecialHoursConfig> implements UmbPropertyEditorUiElement {
    ...
    private _createSpecialDay(): SpecialDay {
        return {
            date: null,
            isOpen: !this._config.defaultToClosed,
            openComment: '',
            closedComment: '',
            hoursOfBusiness: [this._createHours()]
        };
    }
    ...
    private _updateDate(dayIndex: number, value: string) {
        this._days[dayIndex].date = value;
        this._updateValue();
    }
                        ...
                        <div class="day-header">
                            <div class="day-date">
                                <uui-input
                                    type="date"
                                    .value=${day.date || ''}
                                    @change=${(e: Event) => this._updateDate(dayIndex, (e.target as HTMLInputElement).value)}
